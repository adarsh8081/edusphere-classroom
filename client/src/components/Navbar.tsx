                      ...
                      <Sheet>
                        ...
                        <SheetContent side="right" className="w-[300px] glass-panel border-l border-white/10 p-0">
                          ...
                          <div className="flex flex-col p-4 gap-1">
                            {navItems.map((item) => (
                              <Link key={item.href} href={item.href} className={`flex items-center gap-3 p-3 rounded-xl transition-colors font-bold ${location === item.href ? "bg-primary/10 text-primary" : "hover:bg-white/5 text-muted-foreground"}`}>
