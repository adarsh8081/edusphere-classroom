...
import { Send, Users, MessageSquare, Search, Plus } from "lucide-react";
        ...
        <div className="flex flex-col h-screen bg-background">
            ...
            <div className="flex flex-1 overflow-hidden border-t">
                ...
                {selectedConversation ? (
                    <div className="flex-1 flex flex-col bg-[#fafafa] dark:bg-card/30">
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center text-muted-foreground p-12 bg-muted/5 backdrop-blur-sm">
