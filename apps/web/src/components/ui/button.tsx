...
const buttonVariants = cva(
  ...
  " btn-tactile",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground border border-primary-foreground/20 rounded-xl",
        destructive:
          "bg-destructive text-destructive-foreground border border-white/20 rounded-xl",
        outline:
          "border border-input bg-transparent shadow-sm hover:bg-accent hover:text-accent-foreground rounded-xl",
        secondary:
